...
checkLogined();
$sql="select id,username,email,regTime,activeFlag from user";
$rows=fetchAll($sql);
if(!$rows){
            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        ...
                        <a href="adduser.html" class="btn-flat success pull-right">
                            <span>&#43;</span>
                            新用户
                        </a>
                    </div>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                </th><th class="span2 sortable">
                                    <span class="line"></span>邮政编码
                                </th>
                                 <th class="span3 sortable align-right">
                                    <span class="line"></span>是否激活
                                </th>
                                <th class="span3 sortable align-right">
                         ...
                         <?php  foreach($rows as $row):?>
                            <tr>
                                ...
                                <td><img src="img/contact-img.png" class="img-circle avatar hidden-phone" />
                                     ...
                                     <span class="subtext">测试</span></td>
                                <td><?php echo date("Y-m-d H:i:s",$row['regTime']);?></td>
                                <td><a href="#"><?php echo $row['email'];?></a></td>
                                <?php $result=fetchOne("select * from address where userid = $row[id]");?>
                                <td><a href="#"><?php echo $result['realname'];?></a></td>
                                <td><a href="#"><?php echo $result['address'];?></a></td>
                                <td><a href="#"><?php echo $result['telephone'];?></a></td>
                                <td><a href="#"><?php echo $result['postcode'];?></a></td>
                                <td class="align-right">
                                        <?php 
                                        echo $row['activeFlag']==0?"未激活":"激活";
                                        ?>
                                 </td>
                                <td class="align-right"><input type="button" value="修改" class="btn" onclick="editUser(<?php echo $row['id'];?>)"><input type="button" value="删除" class="btn"  onclick="delUser(<?php echo $row['id'];?>)"></td>
                            </tr>
                            <?php endforeach;?>
                        </tbody>
                    </table>
