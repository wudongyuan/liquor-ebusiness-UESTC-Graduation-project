...
<div class="headerBar">
	<div class="logoBar login_logo">
		<div class="comWidth">
			...
			<h3 class="welcome_title">酒类电商平台 欢迎登陆</h3>
		</div>
	</div>
</div>
...
<div class="loginBox">
	...
	<form action="doLogin.php" method="post">
			<ul class="login">
				...
				<img src="getVerify.php" alt="看不清，请点击刷新" title="验证码" onClick="this.src=this.src" /><p>点击刷新</p>
...
<div class="hr_25"></div>
<div class="footer">
	<p><a href="#">简介</a><i>|</i><a href="#">公告</a><i>|</i> <a href="#">招纳贤士</a><i>|</i><a href="#">联系我们</a><i>|</i>客服热线：400-400-1234</p>
