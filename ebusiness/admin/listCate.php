            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        ...
                        <a href="addCate.html" class="btn-flat success pull-right">
                            <span>&#43;</span>
                            新分类
                        </a>
                    </div>
                        ...
                        <!-- row -->
                         ...
                         <?php  foreach($rows as $row):?>
                            <tr>
                                ...
                                <td align="right"><input type="button" value="修改" class="btn" onclick="editCate(<?php echo $row['id'];?>)"><input type="button" value="删除" class="btn"  onclick="delCate(<?php echo $row['id'];?>)"></td>
                            </tr>
                            <?php endforeach;?>
