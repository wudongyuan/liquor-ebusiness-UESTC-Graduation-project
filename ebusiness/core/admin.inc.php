...
function addAddress($id){
	$arr=$_POST;
	if(insert("address", $arr)){
		$mes="添加成功!<br/><a href='addAddress.html'>继续添加</a>|<a href='listUser.php'>查看列表</a>";
	}else{
		$mes="添加失败!<br/><a href='addAddress.html'>重新添加</a>|<a href='listUser.php'>查看列表</a>";
	}
	return $mes;
}
